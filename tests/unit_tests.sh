...
run_test "Arg: Missing file for -f (flag follows)" 1 "" "-f" "-r"
...
run_test "Upload val: Directory default (pwd)" 0 "" "-r"
run_test "Upload val: Multiple valid directories" 0 "" "-r" "test_dir" "test_dir2"
run_test "Upload val: One invalid directory" 1 "" "-r" "test_dir" "nonexistent_dir"
...
run_test "Download val: Multiple directories (-d)" 0 "" "--get" "-r" "remote_dir1" "remote_dir2"
